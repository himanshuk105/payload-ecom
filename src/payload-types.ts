  ...
  hero: {
    ...
    links?:
      | {
          ...
          newTab?: boolean | null;
          buttonVariant?: ('solid' | 'outline' | 'ghost') | null;
          buttonColor?: string | null;
          buttonTextColor?: string | null;
          buttonSize?: ('small' | 'medium' | 'large') | null;
          buttonRounded?: ('none' | 'sm' | 'md' | 'lg' | 'full') | null;
          /**
           * Icon name or class (e.g., 'arrow-right', 'download')
           */
          icon?: string | null;
    ...
    minHeight?: ('50vh' | '60vh' | '70vh' | '80vh' | '90vh' | '100vh') | null;
    ...
    headingWeight?: ('normal' | 'medium' | 'semibold' | 'bold' | 'extrabold') | null;
    headingColor?: string | null;
    subheadingSize?: ('small' | 'medium' | 'large') | null;
    subheadingColor?: string | null;
    subheadingStyle?: ('normal' | 'italic') | null;
    headingMarginBottom?: ('4' | '6' | '8') | null;
    subheadingMarginBottom?: ('4' | '6' | '8') | null;
  };
  layout: (
    | CallToActionBlock
    | ContentBlock
        ...
        'Select Type'?:
          | (
              ...
              | {
                  ...
                  id?: string | null;
                  blockName?: string | null;
                  blockType: 'product-category-block';
                }
            )[]
          | null;
        Heading?: string | null;
